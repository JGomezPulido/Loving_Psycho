...
En una partida o cita se podrán obtener tres finales distintintos:
     1.-Derrota: si la barra de instinto asesino llega al máximo y terminas matando a tu cita.
     2.-Empate: si la cita termina antes de tiempo, ya sea porque tu cita ha huido o porque tu cita se ha aburrido de vuestra conversación.
     3.-Victoria: si has logrado controlar con éxito tu barra de instinto asesino, al mismo tiempo que has conseguido agradar a tu cita, has triunfado en tu cita.
